...
use crate::app::models::{NewReferenceItem, ReferenceItem, ReferenceItemSubmission};
...
// response data for created reference item with submission details
#[derive(Debug, Deserialize, Serialize)]
    ...
    let res = web::block(move || {
        ...
        if let Some(data_url) = reference_item_data.url.clone() {
            ...
            if let Ok(item_data) = existing_item {
                ...
                let new_item_sub = ReferenceItemSubmission {
